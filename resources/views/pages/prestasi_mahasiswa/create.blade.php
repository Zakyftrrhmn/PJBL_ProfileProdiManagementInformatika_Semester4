@extends('layouts.app')
@section('title', 'Tambah Data Prestasi Mahasiswa')
@section('content')
    ...
    <div class="flex-none w-full max-w-full px-3">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            ...
            <div class="flex-auto px-6 pt-5 pb-6">
                <form action="{{ route('admin.prestasi_mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama_mahasiswa" name="nama_mahasiswa" class="block w-full px-4 py-2 text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('nama_mahasiswa') border-red-500 dark:border-red-500 @enderror" value="{{ old('nama_mahasiswa') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="nim" name="nim" class="block w-full px-4 py-2 text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('nim') border-red-500 dark:border-red-500 @enderror" value="{{ old('nim') }}" required>
                        @error('nim')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama_lomba" name="nama_lomba" class="block w-full px-4 py-2 text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('nama_lomba') border-red-500 dark:border-red-500 @enderror" value="{{ old('nama_lomba') }}" required>
                        @error('nama_lomba')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="penyelenggara" name="penyelenggara" class="block w-full px-4 py-2 text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('penyelenggara') border-red-500 dark:border-red-500 @enderror" value="{{ old('penyelenggara') }}" required>
                        @error('penyelenggara')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="tanggal_lomba" name="tanggal_lomba" class="block w-full px-4 py-2 text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('tanggal_lomba') border-red-500 dark:border-red-500 @enderror" value="{{ old('tanggal_lomba') }}" required>
                        @error('tanggal_lomba')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
