                  ...
                  <table id="kurikulumTable" class="items-center justify-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                    <thead class="align-bottom">
                      <tr>
                        ...
                        <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Nama Laporan</th>
                       <th class="px-6 py-3 font-bold uppercase align-middle bg-transparent border-b shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70 !text-center">File Laporan</th>
                    ...
                    <tbody class="border-t">
                      @foreach ($laporan_kepuasan as $lk)
                      <tr>
                        ...
                        <td class="align-middle bg-transparent text-center">
                          <div class="my-auto">                            
                            @if ($lk->file_laporan)
                              <a 
                                href="{{ asset('storage/laporan_kepuasan/' . $lk->file_laporan) }}" 
                                download 
