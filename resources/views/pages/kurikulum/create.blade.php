            ...
            <div class="flex-auto px-6 pt-5 pb-6">
                <form action="{{ route('kurikulum.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama_kurikulum" name="nama_kurikulum" class="block w-full px-4 py-2 text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('nama_kurikulum') border-red-500 dark:border-red-500 @enderror" value="{{ old('nama_kurikulum') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="file_kurikulum" name="file_kurikulum" accept=".pdf,.doc,.docx" class="block w-full text-sm text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700 dark:bg-slate-700 dark:text-white dark:border-slate-600 @error('file_kurikulum') border-red-500 dark:border-red-500 @enderror">
