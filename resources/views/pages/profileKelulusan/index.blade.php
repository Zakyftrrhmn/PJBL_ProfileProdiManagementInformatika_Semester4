              ...
              <tr>
                ...
                <td class="px-6 py-2 text-sm text-center">
                  <div class="flex justify-center space-x-2">
                    ...
                    <form action="{{ route('admin.profile_kelulusan.destroy', $p) }}" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-2 dark:border-red-500 dark:text-red-500 dark:hover:bg-red-600 flex items-center">
