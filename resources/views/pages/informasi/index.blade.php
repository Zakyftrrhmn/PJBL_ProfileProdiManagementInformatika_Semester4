              ...
              <tr>
                ...
                <td class="px-6 py-3 align-middle bg-transparent text-center whitespace-nowrap">
                  <div class="flex space-x-1 justify-center">
                   ...
                   <form
                      action="{{ route('admin.informasi.destroy', $i) }}"
                      method="POST"
                  ...
                  >
                      ...
                      <button
                          type="submit"
                          class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900"
                          {{-- Hapus atribut onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')" --}}
                      >
